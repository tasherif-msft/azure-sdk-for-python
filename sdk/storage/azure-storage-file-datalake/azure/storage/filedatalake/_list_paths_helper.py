...
from ._models import PathProperties, DeletedPathProperties, BlobProperties
from ._deserialize import return_headers_and_deserialized_path_list, get_deleted_path_properties_from_generated_code
...
class DeletedPathsPropertiesPaged(PageIterator):
    ...
    def __init__(
            ...
            delimiter=None,
            location_mode=None):
        super(DeletedPathsPropertiesPaged, self).__init__(
            get_next=self._get_next_cb,
            extract_data=self._extract_data_cb,
            continuation_token=continuation_token or ""
        )
    ...
    def _build_item(self, item):
        ...
        if isinstance(item, BlobItemInternal):
            blob = get_deleted_path_properties_from_generated_code(item)  # pylint: disable=protected-access
