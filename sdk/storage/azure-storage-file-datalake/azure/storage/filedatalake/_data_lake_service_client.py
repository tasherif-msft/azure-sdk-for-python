...
from ._models import UserDelegationKey, FileSystemPropertiesPaged, LocationMode, DatalakeAnalyticsLogging, \
    DatalakeMetrics, DatalakeCorsRule, DatalakeRetentionPolicy, DatalakeStaticWebsite
...
class DataLakeServiceClient(StorageAccountHostsMixin):
    ...
    def set_service_properties(
            ...
            cors=None,  # type: Optional[List[DatalakeCorsRule]]
    ...
    def get_service_properties(self, **kwargs):
        ...
        :rtype: Dict[str, Any]
        """
        return self._blob_service_client.get_service_properties(**kwargs)  # pylint: disable=protected-access
